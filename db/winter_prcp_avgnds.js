...
const file_keys = ['ge001hi', 'ge010hi'];
...
var map_row = function(row, file_key){
	...
	var stat_key = 'winter_prcp_avgnds_' + file_key;
...
file_keys.forEach(function(file_key){
	...
	var file_path = config.noaa_path + 'products/precipitation/djf-prcp-avgnds-' + file_key + '.txt';
