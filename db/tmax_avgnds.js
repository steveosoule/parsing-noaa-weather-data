...
const file_keys = ['grth040', 'grth050', 'grth060', 'grth070', 'grth080', 'grth090', 'grth100', 'lsth032'];
...
var map_row = function(row, file_key){
	...
	var stat_key = 'tmax_avgnds_' + file_key;
...
file_keys.forEach(function(file_key){
	...
	var file_path = config.noaa_path + 'products/temperature/ann-tmax-avgnds-' + file_key + '.txt';
