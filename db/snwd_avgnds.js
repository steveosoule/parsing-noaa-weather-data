...
const file_keys = ['ge001wi', 'ge003wi', 'ge005wi', 'ge010wi'];
...
var map_row = function(row, file_key){
	...
	var stat_key = 'ann_snwd_avgnds_' + file_key;
...
file_keys.forEach(function(file_key){
	...
	var file_path = config.noaa_path + 'products/precipitation/ann-snwd-avgnds-' + file_key + '.txt';
