...
const file_keys = ['ge001ti', 'ge010ti'];
...
var map_row = function(row, file_key){
	...
	var stat_key = 'ann_snow_avgnds_' + file_key;
...
file_keys.forEach(function(file_key){
	...
	var file_path = config.noaa_path + 'products/precipitation/ann-snow-avgnds-' + file_key + '.txt';
